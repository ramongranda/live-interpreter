...
CUDA_ROOT="${OVT_CUDA_TOOLKIT_ROOT:-${ROOT}/.venv-cuda-libs/lib/python3.12/site-packages/nvidia/cu13}"
export CUDAToolkit_ROOT="${CUDA_ROOT}"
export CUDA_HOME="${CUDA_ROOT}"
export PATH="${CUDA_ROOT}/bin:${CUDA_ROOT}/nvvm/bin:${PATH}"
export CMAKE_CUDA_ARCHITECTURES="${OVT_CMAKE_CUDA_ARCHITECTURES:-120}"
