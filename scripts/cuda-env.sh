...
CUDA_WHEEL_VENV="${LI_CUDA_WHEEL_VENV:-${ROOT}/.venv-cuda-libs}"
...
PYTORCH_LIB_PATH="${LI_PYTORCH_LIB_PATH:-$(python_torch_lib_path)}"
CUDA_LIB_PATH="${LI_CUDA_LIB_PATH:-$(cuda_wheel_lib_path)}"
EXTRA_CUDA_LIB_PATH="${LI_EXTRA_CUDA_LIB_PATH:-/home/rgranda/.local/ollama-v0.30.6/lib/ollama/cuda_v12:/home/rgranda/.cache/uv/archive-v0/7fYrxrEsT4mtow-nv-N7X/triton/backends/nvidia/lib/cupti}"
